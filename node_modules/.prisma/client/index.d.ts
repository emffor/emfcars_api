...
export namespace Prisma {
  ...
  */
  ...
  export type TransmissionsCountOutputTypeGetPayload<
    S extends boolean | null | undefined | TransmissionsCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? TransmissionsCountOutputType
    : S extends undefined
    ? never
    : S extends TransmissionsCountOutputTypeArgs
    ?'include' extends U
    ? TransmissionsCountOutputType 
    : 'select' extends U
    ? {
  ...
  export type TransmissionsGroupByArgs = {
    ...
    by: Array<TransmissionsScalarFieldEnum>
  ...
  type GetTransmissionsGroupByPayload<T extends TransmissionsGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type TransmissionsGetPayload<
    S extends boolean | null | undefined | TransmissionsArgs,
    U = keyof S
      > = S extends true
        ? Transmissions
    : S extends undefined
    ? never
    : S extends TransmissionsArgs | TransmissionsFindManyArgs
    ?'include' extends U
    ? Transmissions  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Cars' ? Array < CarsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? TransmissionsCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Cars' ? Array < CarsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? TransmissionsCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Transmissions ? Transmissions[P] : never
  } 
    : Transmissions
  : Transmissions


  type TransmissionsCountArgs = Merge<
  ...
  export interface TransmissionsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Transmissions'> extends True ? CheckSelect<T, Prisma__TransmissionsClient<Transmissions>, Prisma__TransmissionsClient<TransmissionsGetPayload<T>>> : CheckSelect<T, Prisma__TransmissionsClient<Transmissions | null, null>, Prisma__TransmissionsClient<TransmissionsGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Transmissions'> extends True ? CheckSelect<T, Prisma__TransmissionsClient<Transmissions>, Prisma__TransmissionsClient<TransmissionsGetPayload<T>>> : CheckSelect<T, Prisma__TransmissionsClient<Transmissions | null, null>, Prisma__TransmissionsClient<TransmissionsGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Transmissions>>, PrismaPromise<Array<TransmissionsGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__TransmissionsClient<Transmissions>, Prisma__TransmissionsClient<TransmissionsGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find one Transmissions that matches the filter or throw
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends TransmissionsAggregateArgs>(args: Subset<T, TransmissionsAggregateArgs>): PrismaPromise<GetTransmissionsAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, TransmissionsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTransmissionsGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__TransmissionsClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   */
  export type TransmissionsFindUniqueOrThrowArgs = TransmissionsFindUniqueArgsBase
      

  /**
   * Transmissions: findFirstOrThrow
   */
  export type TransmissionsFindFirstOrThrowArgs = TransmissionsFindFirstArgsBase
  ...
  export type CarsGetPayload<
    ...
    ? Cars  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Transmissions' ? TransmissionsGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Brands' ? BrandsGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Transmissions' ? TransmissionsGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
  ...
  export class Prisma__CarsClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Transmissions<T extends TransmissionsArgs = {}>(args?: Subset<T, TransmissionsArgs>): CheckSelect<T, Prisma__TransmissionsClient<Transmissions | Null>, Prisma__TransmissionsClient<TransmissionsGetPayload<T> | Null>>;
  ...
  export type CarsWhereInput = {
    ...
    Transmissions?: XOR<TransmissionsRelationFilter, TransmissionsWhereInput> | null
    transmissionsId?: StringNullableFilter | string | null
  ...
  export type CarsScalarWhereWithAggregatesInput = {
    ...
    transmissionsId?: StringNullableWithAggregatesFilter | string | null
  ...
  export type CarsUpdateInput = {
    ...
    Transmissions?: TransmissionsUpdateOneWithoutCarsNestedInput
  ...
  export type CarsUncheckedUpdateInput = {
    ...
    creation_year?: IntFieldUpdateOperationsInput | number
    model_year?: IntFieldUpdateOperationsInput | number
    transmissionsId?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type TransmissionsRelationFilter = {
    is?: TransmissionsWhereInput | null
    isNot?: TransmissionsWhereInput | null
  }
  ...
  export type TransmissionsUpdateOneWithoutCarsNestedInput = {
    create?: XOR<TransmissionsCreateWithoutCarsInput, TransmissionsUncheckedCreateWithoutCarsInput>
    connectOrCreate?: TransmissionsCreateOrConnectWithoutCarsInput
